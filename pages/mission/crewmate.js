    ...
    return (
        <Wrapper planetID={planetID}>
            <div className="maincontent">
                <h1>TEAM <br/><span style={{color: warnaplanet[planetID-1]}}>{namaplanet[planetID-1]}</span></h1>
                <div className="list-group">
                    <p className="badge">CREWMATES</p>
                    <div className="names">
                        <p>{crews[planetID-1].names[0]}&ensp;<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="18" height="18" rx="4" fill="#FFF500"/><path d="M9.07413 4.172C9.55947 4.172 9.97013 4.186 10.3061 4.214C10.6515 4.23267 10.9641 4.27 11.2441 4.326C11.5241 4.37267 11.8181 4.438 12.1261 4.522L11.9301 6.454C11.6128 6.44467 11.3188 6.43533 11.0481 6.426C10.7775 6.41667 10.4881 6.412 10.1801 6.412C9.87213 6.40267 9.50347 6.398 9.07413 6.398C8.68213 6.398 8.3788 6.47733 8.16413 6.636C7.94947 6.79467 7.80013 7.07467 7.71613 7.476C7.63213 7.87733 7.59013 8.442 7.59013 9.17C7.59013 9.898 7.63213 10.4627 7.71613 10.864C7.80013 11.2653 7.94947 11.5453 8.16413 11.704C8.3788 11.8627 8.68213 11.942 9.07413 11.942C9.75547 11.942 10.3201 11.9373 10.7681 11.928C11.2255 11.9093 11.6828 11.872 12.1401 11.816L12.3361 13.734C11.8695 13.8927 11.3888 14.0047 10.8941 14.07C10.4088 14.1353 9.80213 14.168 9.07413 14.168C8.03813 14.168 7.20747 14.0093 6.58213 13.692C5.96613 13.3653 5.51813 12.838 5.23813 12.11C4.96747 11.382 4.83213 10.402 4.83213 9.17C4.83213 7.938 4.96747 6.958 5.23813 6.23C5.51813 5.502 5.96613 4.97933 6.58213 4.662C7.20747 4.33533 8.03813 4.172 9.07413 4.172Z" fill="black"/></svg></p>
                        <p>{crews[planetID-1].names[1]}</p>
                        <p>{crews[planetID-1].names[2]}</p>
                        <p>{crews[planetID-1].names[3]}</p>
                        <p>{crews[planetID-1].names[4]}</p>
                    </div>
                </div>
                <div className="pagebtn">
                    <button onClick={()=> planetID > 1 ? setplanetID(planetID - 1) : "" } className={`${planetID > 1 ? "" : "samar"} prev`}><svg width="25" height="28" viewBox="0 0 25 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.75001 16.1651C1.08333 15.2028 1.08334 12.7972 2.75 11.8349L19.25 2.30866C20.9167 1.34641 23 2.54922 23 4.47372L23 23.5263C23 25.4508 20.9167 26.6536 19.25 25.6913L2.75001 16.1651Z" stroke="white" stroke-width="3"/></svg></button>
                    <button onClick={()=> planetID < 8 ? setplanetID(planetID + 1) : "" } className={`${planetID < 8 ? "" : "samar"} next`}><p>NEXT</p><svg width="27" height="30" viewBox="0 0 27 30" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26 13.2679C27.3333 14.0377 27.3333 15.9622 26 16.732L3.5 29.7224C2.16667 30.4922 0.499999 29.53 0.499999 27.9904L0.5 2.00962C0.5 0.470019 2.16667 -0.492234 3.5 0.277567L26 13.2679Z" fill="#180F4A"/></svg></button>
                </div>
            </div>

            <div className="planetsmove">
                <div className="eachplanet">
                    <div className={`${ planetID == 1 ? "zoomed" : "" } ${ planetID > 1 ? "gone" : "" }`}>
                        <img src="/img/8planet/1.svg" alt=""/>
                        <p>MERKURIUS</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 2 ? "zoomed" : "" } ${ planetID > 2 ? "gone" : "" }` }>
                        <img src="/img/8planet/2.svg" alt=""/>
                        <p>VENUS</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 3 ? "zoomed" : "" } ${ planetID > 3 ? "gone" : "" }` }>
                        <img src="/img/8planet/3.svg" alt=""/>
                        <p>MARS</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 4 ? "zoomed" : "" } ${ planetID > 4 ? "gone" : "" }` }>
                        <img src="/img/8planet/4.svg" alt=""/>
                        <p>JUPITER</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 5 ? "zoomed" : "" } ${ planetID > 5 ? "gone" : "" }` }>
                        <img src="/img/8planet/5.svg" alt=""/>
                        <p>SATURNUS</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 6 ? "zoomed" : "" } ${ planetID > 6 ? "gone" : "" }` }>
                        <img src="/img/8planet/6.svg" alt=""/>
                        <p>URANUS</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 7 ? "zoomed" : "" } ${ planetID > 7 ? "gone" : "" }` }>
                        <img src="/img/8planet/7.svg" alt=""/>
                        <p>NEPTUNUS</p>
                    </div>
                </div>
                <div className="eachplanet">
                    <div className={`${ planetID == 8 ? "zoomed" : "" } ${ planetID > 8 ? "gone" : "" }` }>
                        <img src="/img/8planet/8.svg" alt=""/>
                        <p>PLUTO</p>
                    </div>
                </div>
            </div>
...
const Wrapper = Styled.div(({planetID}) =>`
    ...
    .planetsmove{
        ...
        align-items: center;
        transform: translateX(-${240*(planetID-1)}px);
